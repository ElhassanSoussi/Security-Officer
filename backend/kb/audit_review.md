...
## What this covers
The audit log tracks every significant action in your organization — uploads, runs, exports, user changes — for compliance and accountability.
...
Use the **Export** button on the audit page to download a CSV of filtered results.
