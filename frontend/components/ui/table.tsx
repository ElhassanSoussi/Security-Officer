...
>(({ className, ...props }, ref) => (
    <th
        ref={ref}
        className={cn(
            "sticky top-0 bg-card h-10 px-3 text-left align-middle font-semibold text-xs uppercase tracking-wider text-muted-foreground bg-muted/40 [&:has([role=checkbox])]:pr-0",
            className
        )}
        {...props}
    />
